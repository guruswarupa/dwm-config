...
static Key keys[] = {
    ...
    { MODKEY|ControlMask,           XK_b,                      spawn,          SHCMD ("xbacklight -inc 10")},
    { MODKEY|ShiftMask,             XK_b,                      spawn,          SHCMD ("xbacklight -dec 10")},
    { MODKEY|ControlMask|ShiftMask, XK_s,                      spawn,          SHCMD ("amixer sset Master 5%- unmute")},
    { MODKEY|ControlMask,	    XK_m,                      spawn,          SHCMD ("amixer sset Master $(amixer get Master | grep -q '\\[on\\]' && echo 'mute' || echo 'unmute')")},
    { MODKEY|ControlMask,           XK_s,                      spawn,          SHCMD ("amixer sset Master 5%+ unmute")},
    ...
    { MODKEY,                       XK_l,                      spawn,          SHCMD("systemctl suspend")},
};
